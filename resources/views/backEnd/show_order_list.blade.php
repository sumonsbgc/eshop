                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="button" class="btn btn-primary" onclick="order_shipping({{$item->id}},{{$item->user_id}})">Shipping</button>
                                                        <button type="button" class="btn btn-danger" onclick="cancel_order({{$item->id}},{{$item->user_id}})">Cancel Order</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
