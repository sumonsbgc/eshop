...
class PostController extends Controller
{
    ...
    {
        $posts = Post::where(['post_status' => 'publish', 'post_type' => 'post'])->get();
        return view('backEnd.post_lists', compact('posts'));
    }
    ...
    {
        $category = Category::where(['post_type' => 'post'])->get();
        return view('backEnd.post_create', compact('category'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('backEnd.post_edit', compact('post'));
    }
